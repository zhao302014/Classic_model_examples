...
class function4_view(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default=r'E:\software\pytorch_test\yolov5\yolov5-v5.0\runs\train\exp19\weights\best.pt', help='model.pt path(s)')
...
class StackedLayout(QMainWindow):
    def __init__(self):
        ...
        window_pale = QtGui.QPalette()
        window_pale.setBrush(self.backgroundRole(), QtGui.QBrush(QtGui.QPixmap("F:/108.jpg")))
        self.setPalette(window_pale)
        ...
        self.titlelabel.setPixmap(QPixmap("F:/me.png"))
        self.titlelabel.setScaledContents(True)
